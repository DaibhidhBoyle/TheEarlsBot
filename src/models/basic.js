...
Basic.prototype.bindBasic = function () {
  PubSub.subscribe(pschannel.basic, (msg, data) => {
    ...
    if (this.message.includes(`!welcome`)){
      ...
      this.response = `Catch the stream 6pm CT everyday (cept sunday)! and  special early Sunday stream at 1pm CT. Keep up to date on any schedule changes at the discord: discordapp.com/invite/PmK33d4`
    }
