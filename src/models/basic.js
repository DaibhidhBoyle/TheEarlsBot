...
Basic.prototype.bindBasic = function () {
  PubSub.subscribe(pschannel.basic, (msg, data) => {
    ...
    if (this.message.includes(`!welcome`)){
      ...
      this.response = `Catch the stream 4pm CT every week day! and to catch bonus Saturday streams follow with notifications or join the discord: discord.gg/vPhEzMbYfj`
    }
