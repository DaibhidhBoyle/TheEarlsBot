...
Shoutout.prototype.bindShoutout = function () {
  ...
  PubSub.subscribe(SHOUTOUT, (msg, data) => {
    ...
    if(arrayLength === 1){
      ...
      this.response = `Don't let your time on twitch when the the Earl of Suds logs out. Checkout out more great streamers like *** www.twitch.tv/${this.shoutoutList[0]} *** or  *** www.twitch.tv/${this.shoutoutList[1]} *** or  *** www.twitch.tv/${this.shoutoutList[2]} ***`
    } else {
